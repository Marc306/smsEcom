...
<head>
    ...
    <link rel="stylesheet" href="css/page/my-purchase.css">
    ...
    <div class="body-page">
        ...
        <nav class="side-bar2" id="sidebar">
            ...
            <div class="sidebar-links">
                ...
                <a class="sidebar-link active" href="user-purchase.php">
        ...
        <main class="main-div">
            <div class="selected-transaction">
                <a class="all-transaction active" href="user-purchase.php">All</a>
                <a class="toPay-transaction" href="user-toPay.php">To Pay</a>
                <a class="toReceive-transaction" href="user-toReceive.php">To Receive</a>
                <a class="completed-transaction" href="user-completed.php">Completed</a> 
            </div>
