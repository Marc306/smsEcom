...
class Details {
    ...
    // Updated buyNowButton method to be async
    async buyNowButton() {
        const buyNowBtn = document.querySelector(".js-buy-now-btn");
        ...
        buyNowBtn.addEventListener("click", async () => {
            ...
            // Wait for the buyNowItemAndIfDuplicate to finish before redirecting
            await buyNowItemAndIfDuplicate();
...
document.addEventListener("DOMContentLoaded", () => {
    async function fetchProductDetailsLoad() {
        try {
            ...
            // Await buyNowItemAndIfDuplicate to ensure it's done before continuing
            await buyNowItemAndIfDuplicate();
